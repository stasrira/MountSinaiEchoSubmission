...
class DataRetrievalAliquot():
    def __init__(self, sub_aliquot, request_obl):  # sub_aliquot, data_folder, request_obl, file_row_num =''
    ...
    def get_data_by_rownum(self, filepath, rawdata_row_num, isexcel=True):
    ...
    def get_data_from_predefined_file_text(self, config_source, data_folder, file_row_num=''):
        ...
        if get_data_by == 'row_num':
            ...
            _str = "Unexpected value of 'file_content_details/get_data_by' ({}) was provided. " \
